<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="usuarios.aspx.cs" Inherits="controlPracticasProfesionale.Forms.usuarios" %>
    ...
    <div id="main-container">
        <div id="head">
            ...
            <div class="row" ">
                ...
                <div class="col-md-10">
                    <h4><label class="alert-success">USUARIOS</label> <label id="btnNuevo" class="btn btn-primary pull-right col-md-2">Nuevo</label></h4>
      ...
      <div id="modal-usuario" class="container-fluid">
        <header class="header">
        ...
        <form role="form" id="formDatos" name="formDatos" data-toggle="validator">
            <div class="form-group">
                ...
                <input id="txtMatricula" class="no-simbolos-especiales form-control campo-editable" type="text" required data-required-error='Requerido'/>
           <div class="help-block with-errors"></div>
            </div>
            <div class="form-group">
                <label class="col-form-label">Contraseña</label>
                <input id="txtContrasenia" class="no-simbolos-especiales form-control campo-editable" type="text" required data-required-error='Requerido'/>
           <div class="help-block with-errors"></div>
           ...
           <div class="help-block with-errors"></div>
             ...
             <div class="form-group">
                ...
                <input id="txtEmail" class="no-simbolos-especiales form-control campo-editable" type="text" required data-required-error='Requerido'/>
           <div class="help-block with-errors"></div>
           ...
           <div class="help-block with-errors"></div>
            ...
            <div  class="form-group">
                ...
                <select class="form-control" id="comboTipoUsuario" >
                </select>
            </div>
        </form>
