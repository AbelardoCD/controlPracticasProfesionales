<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="encargadoProyecto.aspx.cs" Inherits="controlPracticasProfesionale.Forms.encargadoProyecto" %>
...
<body class="body-expanded">
    ...
    <div id="main-container">
        <div id="head">
            ...
            <div class="row" ">
                ...
                <div class="col-md-8">
                    <h4><label class="alert-success">Encargado Proyecto</label> <label id="btnNuevo" class="btn btn-primary pull-right col-md-2">Nuevo</label></h4>
      ...
      <div id="modal-encargado" class="container-fluid">
        <header class="header">
            <label class="col-form-label">NUEVO ENCARGADO</label>
        </header>
        <form id="formDatos" name="formDatos" data-toggle="validator">
           ...
           <div class="help-block with-errors"></div>
            ...
            <div class="form-group">
                ...
                <input id="txtCargo" class="no-simbolos-especiales form-control campo-editable" type="text" required data-required-error='Requerido'/>
           <div class="help-block with-errors"></div>
    ...
    <script src="../js/encargadoProyecto.js"></script>
